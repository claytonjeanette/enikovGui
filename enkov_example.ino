...
AutoDriver boardA(10, 6); // Spinneret
AutoDriver boardB(9, 6); //Forward Back
AutoDriver boardC(5, 6); //Left Right
AutoDriver boardD(3, 6); // Up Down
AutoDriver boardE(8, 6); //DC motor
